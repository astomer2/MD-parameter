...
# 搜索最佳参数
def cluster_contact_matrix(contact_matrixs,DBCV_score_vs_trials, cluster_sizes, samples_values, eps):
    """
    ...
    min_cluster_sizes = list(range(2, cluster_sizes))
    min_samples_values = list(range(2, samples_values))
    eps_values = [x * 0.1 for x in range(1, eps, 2)]
...
def draw_2d_tsne(contact_matrixs, labels, cluster_keys, point_plot):
    ...
    Returns:
    cluster_2D_plot (str): The path to the generated 2D t-SNE plot.
...
def merge_pdb(cluster_keys, cluster_path):
    ...
    Returns:
        every cluster's PDB files merged into one
    """
    cluster_labels_pdb = []
...
def main():
    ...
    best_model = cluster_contact_matrix(contact_matrixs, DBCV_score_vs_trials, cluster_sizes, samples_values, eps)
...
if __name__ == "__main__":
    ...
    peptide_pdb_dir = "/mnt/nas1/lanwei-125/PRLR/ADCP/ADCP_best_pose_pdb/"
    cluster_path = "/mnt/nas1/lanwei-125/PRLR/ADCP/cluster/"
