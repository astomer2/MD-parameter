...
def add_cmap_to_prmtop():
    cmap_para_file = '/mnt/sdc/lanwei/software/ADD-CMAP-master/ff14IDPSFF.para'
    CAMP_scrpt = '/mnt/sdc/lanwei/software/ADD-CMAP-master/ADD-CMAP.py'
    ...
    for prmtop_file in prmtop_files:
        ...
        cmd = ['python3', 
               '/mnt/sdc/lanwei/software/ADD-CMAP-master/ADD_CMAP.py',
               '-p', prmtop_file,  
               '-c', cmap_para_file,
               '-o', output_file,
               '-s']
...
def analysis(reference,target):
    ...
    os.system("mpirun MMPBSA.py.MPI -O -i mmpbsa.in -o energy.dat -do decomp-energy.dat -sp fixed.prmtop -cp complex.prmtop -rp protein.prmtop -lp peptide.prmtop -y fixed.mdcrd")
    os.system("mpirun MMPBSA.py.MPI --clean")
